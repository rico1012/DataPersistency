...
SELECT cursus, begindatum FROM uitvoeringen WHERE uitvoeringen.locatie = 'MAASTRICHT' OR uitvoeringen.locatie = 'UTRECHT';
...
SELECT naam, voorl FROM medewerkers WHERE medewerkers.naam <> 'JANSEN' OR medewerkers.voorl <> 'R';
...
values('S02', '03-02-2022', '7369', 'LEERDAM')
...
VALUES (8001, 'VOSSESTEIN', 'R', 'STAGIAIR', 7782, '12-01-2003',8000 , null , 10)
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
...
VALUES ('D&P','d&p cursus', 'ALG', 2)
ON CONFLICT DO NOTHING;   
INSERT INTO uitvoeringen (cursus, begindatum, docent, locatie)
VALUES ('D&P', '12-2-2022', 7369, 'LEERDAM'),
		('D&P', '12-8-2022', 7369, 'LEERDAM')
ON CONFLICT DO NOTHING;   
INSERT INTO inschrijvingen (cursist, cursus, begindatum, evaluatie)
VALUES (7499, 'D&P', '12-2-2022', 4),
       (7934, 'D&P', '12-2-2022', 5),
       (7698, 'D&P', '12-8-2022', 4)  
ON CONFLICT DO NOTHING;   -- [TEST]
...
UPDATE medewerkers SET maandsal = maandsal*1.055 WHERE functie='verkoop' AND chef!=null;
UPDATE medewerkers SET maandsal = maandsal*1.07 WHERE functie='verkoop' AND chef = null;
...
-- DELETE FROM medewerkers WHERE mnr='7654';
-- Lukt niet omdat persoon nog is ingeschreven voor een cursus
...
INSERT INTO medewerkers (mnr, naam, voorl, functie, chef, gbdatum, maandsal, comm, afd)
VALUES (8069, 'VOSSESTEIN', 'R', 'MANAGER', 7839, '12-01-2003', 3000, NULL, 80)
ON CONFLICT DO NOTHING;  
INSERT INTO afdelingen (anr, naam, locatie, hoofd)
VALUES (80, 'FINANCIEN', 'LEERDAM', 8069)
ON CONFLICT DO NOTHING;   
                                                                                       -- [TEST]
