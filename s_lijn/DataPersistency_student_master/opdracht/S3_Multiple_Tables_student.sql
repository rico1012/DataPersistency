...
SELECT medewerkers.naam AS medewerker, afdelingen.naam AS afdeling, afdelingen.locatie
FROM medewerkers
LEFT JOIN afdelingen ON medewerkers.afd = afdelingen.anr;
...
FROM medewerkers
JOIN schalen ON schalen.ondergrens<=medewerkers.maandsal AND schalen.bovengrens>=medewerkers.maandsal;
