...
FROM medewerkers 
WHERE medewerkers.functie = 'TRAINER' AND medewerkers.gbdatum < to_date('1980', 'yyyy')
OR medewerkers.functie = 'VERKOPER' AND medewerkers.gbdatum < to_date('1980', 'yyyy');
...
SELECT (MAX(gbdatum)-MIN(gbdatum))/365 as verschil, AVG(AGE(CURRENT_DATE, gbdatum)) as gemiddeld
FROM medewerkers;
